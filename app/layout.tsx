...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="et"><body><Header/><main id="main">{children}</main><Footer/></body></html> }
