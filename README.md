...
The accountants page uses an original generated office photograph in `public/accountants-office.jpg`. Its partner inquiry form also opens a prepared email; the privacy link leads to `/privaatsus`. The privacy page describes the current public site's data flow and explicitly identifies information that must be completed and legally reviewed before SaaS accounts launch.
